...
public class ConnectionManager implements ConnectionService {
    ...
    @Override
    public Result add(ConnectionDto connectionDto) {
    ...
    @Override
    public Result update(Connection connection) {
        connectionDao.save(connection);
        return new SuccessResult();
    }
    ...
    private Connection connectionDtoToConnectionConverter(ConnectionDto connectionDto){
        ...
        return new Connection(curriculumVitae, connectionDto.getGithubAccountLink(), connectionDto.getLinkedinAccountLink());
    }
}
